...
const stepIcons: Record<StepType, string> = {
  ...
  right_click_coordinate: '👉',
  master_click_coordinate: '🎯',
  type_text: '⌨️',
  press_key: '🔑',
  keyboard_shortcut: '⌨️',
  select_dropdown: '📋',
...
const stepLabels: Record<StepType, string> = {
  ...
  double_click_coordinate: 'Double Click Coordinates',
  right_click_coordinate: 'Right Click Coordinates',
  master_click_coordinate: 'Master Click Coordinates',
  type_text: 'Type Text',
  press_key: 'Press Key',
